...
object GameTypes : BasicRegistry<GameType<*>>() {
    ...
    ) { MusicSettings.INSTANCE.holeInTheWallMusic } ))
    ...
    ) { MusicSettings.INSTANCE.toGetToTheOtherSideMusic } ))
    ...
    ) { MusicSettings.INSTANCE.skyBattleMusic } ))
    ...
    ) { MusicSettings.INSTANCE.battleBoxMusic } ))
    ...
    ) { MusicSettings.INSTANCE.parkourWarriorDojoMusic } ))
}
