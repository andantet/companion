...
public record DiscordRPClientConfig(long clientId, boolean enabled, boolean displayGame, boolean displayGameTime, boolean displayGameState, boolean displayGameArt, boolean displayQueue) {
    ...
    public static DiscordRPClientConfig createDefaultConfig() {
        return new DiscordRPClientConfig(1026937264309284935L, true, true, true, true, false, true);
    }
}
